...
var appText = [
    ...
    ["password", "Mot de passe <a style='color: blue; text-decoration: underline; cursor : pointer' onclick='openAppPasswordInBrowser()'>(Utiliser mot-de-passe d'application pour les comptes Googles)</a>","Password <a style='color: blue; text-decoration: underline; cursor : pointer' onclick='openAppPasswordInBrowser()'> (Use App-Password for Google accounts)</a>"],
...
var appErrors = [
    ...
    ["invalidLogin1","Email / Mot de passe invalide. Assurez-vous aussi d'avoir utilisé ","Invalid email/password. Make sure you are using "],
    ["invalidLogin2","<a style='color: blue; text-decoration: underline; cursor : pointer' onclick='openAppPasswordInBrowser()'>les mots de passe d'application pour les comptes Google.</a>","<a style='color: blue; text-decoration: underline; cursor : pointer' onclick='openAppPasswordInBrowser()'>App passwords for Google accounts</a>"],
