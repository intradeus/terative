...
function setLocaleText(pageName) {
    ...
    if(pageName == "settings") {
        ...
        ["sendingEmailLabel","sendingEmail"],["emailsmtpLabel","smtpServer"],["emailPasswordLabel","password"],["google-sign-in","googleSignIn"],
...
var appText = [
    ...
    ["googleSignIn", "S'enregistrer avec Google","Sign-in with Google"],
